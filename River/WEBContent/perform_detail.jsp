	...
	<div id="section_middle">
		...
		<div id="section_middle_notice">
			...
			<div id="section_middle_notice_ticket">
				<br><h2>티켓오픈일정</h2> <br>
				<%=performDTO.getOpen_date().substring(0, 10) %> <%=performDTO.getOpen_date().substring(11, 16) %> 일반오픈  <br><br>
				...
				※ 사회적 거리두기 단계 완화 전까지 휠체어석 또한 거리두기를 반영합니다. <br><br>
		...
		<div id="section_middle_ticketGuide">
			...
			<h4>배송</h4>
			- 우편발송을 원하실 경우 공연일 2주 전까지 고객센터로 신청하시기 바랍니다. <br>
		...
		<div id="section_middle_watchGuide">
			...
			- 공연장 내에는 뚜껑이 있는 페트(PET) 생수만 반입이 가능하며, 꽃다발, 음식물 및 반려동물의 반입은 금지하고 있습니다. <br>
				&nbsp; (단, 시각장애인의 안내 보조견 동반 입장은 가능합니다.) <br>
			- 공연 관람일에는 공연장 주변 교통 혼잡이 예상되오니 공연 전 여유롭게 도착해주시기를 부탁드립니다. <br><br>
