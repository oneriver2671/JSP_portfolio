...
<%
  ...
  BoardDTO dto = (BoardDTO)request.getAttribute("article");		// ModifyFormAction.java에서 넘어옴.
%>
...
<title>글 수정</title>
  <!-- CSS 파일 -->
  <link rel="stylesheet" type="text/css" href="../River_Board/write_style.css" media="screen" />
...
<div id="wrap">
  ...
  <section>
  	<div id="main_section">
  		<div class="post">
  			<form action="boardModify.bo?orders=<%= dto.getOrders() %>" name="writeAction" id="writeAction" method="post" enctype="multipart/form-data">
  				...
  				<input type="file" id="post_file" name="post_file" required="required" />	
  				<div class="post_btn">
